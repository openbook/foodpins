...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  servers.each do |key, value|
    ...
    if ENV['VAGRANT_MOUNT'] == 'nfs'
      config.vm.synced_folder "./", "/var/www/foodpins", type: "nfs", nfs_export: true
    else
      config.vm.synced_folder "./", "/var/www/foodpins", owner: "www-data", group: "www-data"
    end
    config.vm.synced_folder "./", "/home/vagrant/foodpins", owner: "vagrant", group: "vagrant"
    config.vm.synced_folder "./", "/home/symfony/foodpins", mount_options: ["uid=1002", "gid=1002"], disabled: true
